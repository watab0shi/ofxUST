...
meta:
	ADDON_NAME = ofxUST
	ADDON_DESCRIPTION = Addon for using HOKUYO AUTOMATIC range sensor (UST Series)
	ADDON_AUTHOR = watab0shi
	ADDON_TAGS = "hardware interface"
	ADDON_URL = https://github.com/watab0shi/ofxUST
...
common:
	...
	ADDON_INCLUDES += libs/urg/include
...
vs:
	# when parsing the file system looking for include paths exclude this for all or
	# a specific platform
	ADDON_LIBS += libs/urg/lib/$(Platform)/urg_cpp.lib
